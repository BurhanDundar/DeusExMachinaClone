  ...
  return (
    <article className="group min-w-0">
      ...
      <div className="relative min-h-[108px] pt-4 pr-10 text-[13px] md:text-sm">
        ...
        {sizes && (
          <div className="absolute inset-x-0 top-12 z-10 flex flex-wrap gap-1 bg-paper py-2">
            {product.availableSizes.map((size) => (
              <button
                ...
                className="focus-ring border border-black px-2 py-1 text-xs hover:bg-black hover:text-white"
              >
                {size}
              </button>
            ))}
